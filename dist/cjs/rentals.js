...
exports.extendRentalExpiration =
  exports.claimRental =
 ...
 */
const createRental = async (connection, wallet, rentalParameters) =>
  (0, _1.withIssueToken)(
...
const claimRental = async (connection, wallet, tokenManagerId, payer) =>
  (0, _1.withClaimToken)(
    new web3_js_1.Transaction(),
    connection,
    wallet,
...
const extendRentalExpiration = async (
  connection,
  wallet,
  tokenManagerId,
  secondsToAdd
