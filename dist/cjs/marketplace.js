...
exports.withRelease =
  exports.withAcceptTransfer =
  exports.withCancelTransfer =
  exports.withInitTransfer =
  exports.withWhitelistMarektplaces =
  exports.withAcceptListing =
  exports.withRemoveListing =
  exports.withUpdateListing =
  exports.withCreateListing =
  exports.withUpdateMarketplace =
  exports.withInitMarketplace =
  exports.withUpdateTransferAuthority =
  exports.withInitTransferAuthority =
...
const withWrapToken = async (
  ...
  if (
    checkTokenManager === null || checkTokenManager === void 0
      ? void 0
      : checkTokenManager.parsed
  ) {
    throw "Token is already wrapped";
  }
  const issuerTokenAccountId = await (0, common_1.findAta)(
    mintId,
    wallet.publicKey,
    true
  );
  ...
  if (!accountInfo) kind = tokenManager_1.TokenManagerKind.Permissioned;
  await (0, transaction_1.withIssueToken)(
    transaction,
    connection,
    wallet,
    {
  ...
  const remainingAccounts = (0, tokenManager_1.getRemainingAccountsForKind)(
    mintId,
    kind
  );
...
const withInitTransferAuthority = async (
  transaction,
  connection,
  wallet,
  name,
  ...
  const transferAuthProgram = (0, transferAuthority_1.transferAuthorityProgram)(
    connection,
    wallet
  );
  ...
  const initTransferAuthorityIx = await transferAuthProgram.methods
    .initTransferAuthority({
      ...
      authority: authority,
      allowedMarketplaces:
        allowedMarketplaces !== null && allowedMarketplaces !== void 0
          ? allowedMarketplaces
          : null,
    })
    .accounts({
...
const withUpdateTransferAuthority = async (
  transaction,
  connection,
  wallet,
  name,
...
const withInitMarketplace = async (
  transaction,
  connection,
  wallet,
  name,
  ...
  const initMarketplaceIx = await transferAuthProgram.methods
    .initMarketplace({
      ...
      authority: wallet.publicKey,
      paymentMints:
        paymentMints !== null && paymentMints !== void 0 ? paymentMints : null,
    })
    .accounts({
...
const withUpdateMarketplace = async (
  transaction,
  connection,
  wallet,
  name,
...
const withCreateListing = async (
  ...
  markeptlaceName,
  paymentAmount,
  paymentMint = web3_js_1.PublicKey.default,
  payer = wallet.publicKey
) => {
  const transferAuthProgram = (0, transferAuthority_1.transferAuthorityProgram)(
    connection,
  ...
  if (checkListing) {
    transaction.add(
      await (0, exports.withUpdateListing)(
        transaction,
        connection,
        wallet,
        mintId,
...
const withUpdateListing = async (
  ...
  const listerMintTokenAccountId = await (0, common_1.findAta)(
    mintId,
    wallet.publicKey,
    true
  );
...
const withAcceptListing = async (
  ...
  if (
    !(paymentManagerData === null || paymentManagerData === void 0
      ? void 0
      : paymentManagerData.parsed)
  ) {
    throw `No payment manager found for marketplace with name ${marketplaceData.parsed.name}`;
  }
  const nativePayment =
    paymentMint.toString() === web3_js_1.PublicKey.default.toString();
  ...
  if (
    listingData.parsed.paymentMint.toString() ===
    transferAuthority_1.WSOL_MINT.toString()
  ) {
    await (0, common_1.withWrapSol)(
      transaction,
      connection,
      (0, common_1.emptyWallet)(buyer),
  ...
  const remainingAccountsForKind = (0,
...
const withWhitelistMarektplaces = async (
  transaction,
  connection,
  wallet,
...
const withAcceptTransfer = async (
  transaction,
  connection,
  wallet,
  mintId,
  ...
  const remainingAccountsForTransfer = [
    ...(0, tokenManager_1.getRemainingAccountsForKind)(
      mintId,
      tokenManagerData.parsed.kind
    ),
    {
