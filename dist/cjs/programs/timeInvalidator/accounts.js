...
exports.getAllTimeInvalidators =
  exports.getExpiredTimeInvalidators =
  exports.getTimeInvalidators =
  exports.getTimeInvalidator =
    void 0;
...
const getExpiredTimeInvalidators = async (connection) => {
  const programAccounts = await connection.getProgramAccounts(
    constants_1.TIME_INVALIDATOR_ADDRESS
  );
  const expiredTimeInvalidators = [];
  const coder = new anchor_1.BorshAccountsCoder(
    constants_1.TIME_INVALIDATOR_IDL
  );
  programAccounts.forEach((account) => {
    var _a;
    try {
      const timeInvalidatorData = coder.decode(
        "timeInvalidator",
        account.account.data
      );
      if (
        (_a = timeInvalidatorData.expiration) === null || _a === void 0
          ? void 0
          : _a.lte(new anchor_1.BN(Date.now() / 1000))
      ) {
