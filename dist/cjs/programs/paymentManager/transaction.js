...
exports.withUpdate =
  exports.withClose =
  exports.withHandleNativePaymentWithRoyalties =
  exports.withHandlePaymentWithRoyalties =
  exports.withManagePayment =
  exports.withInit =
    void 0;
...
const withInit = async (transaction, connection, wallet, params) => {
  ...
  transaction.add(
    await (0, constants_1.paymentManagerProgram)(connection, wallet)
      .methods.init({
        ...
        royaltyFeeShare:
          (_a = params.royaltyFeeShare) !== null && _a !== void 0 ? _a : null,
      })
      .accounts({
        paymentManager: (0, pda_1.findPaymentManagerAddress)(
          params.paymentManagerName
        ),
        authority:
          (_b = params.authority) !== null && _b !== void 0
            ? _b
            : wallet.publicKey,
        payer:
          (_c = params.payer) !== null && _c !== void 0 ? _c : wallet.publicKey,
...
const withHandlePaymentWithRoyalties = async (
  transaction,
  connection,
  wallet,
  params
  ...
  utils_1.withRemainingAccountsForHandlePaymentWithRoyalties)(
    ...
    (_a = params.excludeCretors) !== null && _a !== void 0 ? _a : []
  );
  transaction.add(
    await (0, constants_1.paymentManagerProgram)(connection, wallet)
...
const withHandleNativePaymentWithRoyalties = async (
  transaction,
  connection,
  wallet,
  params
  ...
  transaction.add(
    await (0, constants_1.paymentManagerProgram)(connection, wallet)
      ...
      .accounts({
        ...
        collector:
          (_a = params.collectorId) !== null && _a !== void 0
            ? _a
            : wallet.publicKey,
...
const withUpdate = async (transaction, connection, wallet, params) => {
  ...
  const checkPaymentManager = await (0, common_1.tryGetAccount)(() =>
    (0, accounts_1.getPaymentManager)(connection, paymentManagerId)
  );
      ...
      .methods.update({
        authority:
          (_a = params.authority) !== null && _a !== void 0
            ? _a
            : checkPaymentManager.parsed.authority,
        feeCollector:
          (_b = checkPaymentManager.parsed.feeCollector) !== null &&
          _b !== void 0
            ? _b
            : params.feeCollectorId,
        makerFeeBasisPoints:
          (_c = checkPaymentManager.parsed.makerFeeBasisPoints) !== null &&
          _c !== void 0
            ? _c
            : params.makerFeeBasisPoints,
        takerFeeBasisPoints:
          (_d = checkPaymentManager.parsed.takerFeeBasisPoints) !== null &&
          _d !== void 0
            ? _d
            : params.takerFeeBasisPoints,
        royaltyFeeShare:
          (_f =
            (_e = checkPaymentManager.parsed.royaltyFeeShare) !== null &&
            _e !== void 0
              ? _e
              : params.royaltyFeeShare) !== null && _f !== void 0
            ? _f
            : null,
      })
      .accounts({
