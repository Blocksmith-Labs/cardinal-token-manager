...
exports.withRemainingAccountsForHandlePaymentWithRoyalties =
  exports.withRemainingAccountsForPayment = void 0;
const common_1 = require("@cardinal/common");
const mpl_token_metadata_1 = require("@metaplex-foundation/mpl-token-metadata");
const spl_token_1 = require("@solana/spl-token");
const web3_js_1 = require("@solana/web3.js");
const accounts_1 = require("./accounts");
const withRemainingAccountsForPayment = async (
  transaction,
  connection,
  wallet,
  mint,
  ...
  var _a, _b;
  const payer =
    (_a = options === null || options === void 0 ? void 0 : options.payer) !==
      null && _a !== void 0
      ? _a
      : wallet.publicKey;
  const royaltiesRemainingAccounts = await (0,
  exports.withRemainingAccountsForHandlePaymentWithRoyalties)(
    transaction,
    connection,
    wallet,
  ...
  if (options === null || options === void 0 ? void 0 : options.receiptMint) {
    ...
    const paymentManager = await (0, common_1.tryNull)(
...
const withRemainingAccountsForHandlePaymentWithRoyalties = async (
  transaction,
  connection,
  wallet,
  mint,
  ...
  try {
    const mintMetadataId = (0, common_1.findMintMetadataId)(mint);
    metaplexMintData = await mpl_token_metadata_1.Metadata.fromAccountAddress(
      connection,
      mintMetadataId
    );
  } catch (e) {
      ...
      if (creator.share !== 0) {
        ...
        if (paymentMint.toString() === web3_js_1.PublicKey.default.toString()) {
          ...
          const creatorMintTokenAccount = (
            excludeCreators === null || excludeCreators === void 0
              ? void 0
