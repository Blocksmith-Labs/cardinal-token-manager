...
exports.getAllOfType =
  exports.getTransfersToUser =
  exports.getTransfersFromUser =
  exports.getTransfer =
  exports.getAllListings =
  exports.getListingsForIssuer =
  exports.getListingsForMarketplace =
  exports.getListing =
  exports.getAllMarketplaces =
  exports.getMarketplaceByName =
  exports.getMarketplace =
  exports.getAllTransferAuthorities =
  exports.getTransferAuthorityByName =
  exports.getTransferAuthority =
    void 0;
...
const getAllTransferAuthorities = async (connection) =>
  (0, exports.getAllOfType)(connection, "transferAuthority");
...
const getAllMarketplaces = async (connection) =>
  (0, exports.getAllOfType)(connection, "marketplace");
...
const getListingsForMarketplace = async (connection, marketplaceId) => {
      ...
      filters: [
        {
          memcmp: {
            ...
            bytes: anchor_1.utils.bytes.bs58.encode(
              anchor_1.BorshAccountsCoder.accountDiscriminator("listing")
            ),
          },
        },
  ...
  const coder = new anchor_1.BorshAccountsCoder(
    constants_1.TRANSFER_AUTHORITY_IDL
  );
...
const getAllListings = async (connection) =>
  (0, exports.getAllOfType)(connection, "listing");
      ...
      filters: [
        {
          memcmp: {
            offset: 0,
            bytes: anchor_1.utils.bytes.bs58.encode(
              anchor_1.BorshAccountsCoder.accountDiscriminator("transfer")
            ),
          },
        },
