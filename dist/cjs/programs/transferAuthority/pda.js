 ...
 * @returns
 */
const findTransferAuthorityAddress = async (name) => {
 ...
 * @returns
 */
const findMarketplaceAddress = async (name) => {
    return await web3_js_1.PublicKey.findProgramAddress([anchor_1.utils.bytes.utf8.encode(constants_1.MARKETPLACE_SEED), anchor_1.utils.bytes.utf8.encode(name)], constants_1.TRANSFER_AUTHORITY_ADDRESS);
};
 ...
 * @returns
 */
const findListingAddress = async (mintId) => {
    const [tokenManagerId] = await (0, pda_1.findTokenManagerAddress)(mintId);
    return await web3_js_1.PublicKey.findProgramAddress([anchor_1.utils.bytes.utf8.encode(constants_1.LISTING_SEED), tokenManagerId.toBytes()], constants_1.TRANSFER_AUTHORITY_ADDRESS);
};
 ...
 * @returns
 */
const findTransferAddress = async (mintId) => {
    const [tokenManagerId] = await (0, pda_1.findTokenManagerAddress)(mintId);
    return await web3_js_1.PublicKey.findProgramAddress([anchor_1.utils.bytes.utf8.encode(constants_1.TRANSFER_SEED), tokenManagerId.toBytes()], constants_1.TRANSFER_AUTHORITY_ADDRESS);
};
