...
exports.getTransferReceipt =
  exports.getTokenManagersForIssuer =
  exports.getMintCounter =
  exports.getMintManager =
  exports.getTokenManagersByState =
  exports.getTokenManagers =
  exports.getTokenManager =
    void 0;
...
const getTokenManagersByState = async (connection, state) => {
      ...
      filters: [
        {
          memcmp: {
            ...
            bytes: anchor_1.utils.bytes.bs58.encode(
              anchor_1.BorshAccountsCoder.accountDiscriminator("tokenManager")
            ),
          },
        },
        ...(state
          ? [
              {
                memcmp: {
                  offset: 92,
                  bytes: anchor_1.utils.bytes.bs58.encode(
                    new anchor_1.BN(state).toArrayLike(Buffer, "le", 1)
                  ),
                },
              },
            ]
  ...
  programAccounts.forEach((account) => {
    try {
      const tokenManagerData = coder.decode(
        "tokenManager",
