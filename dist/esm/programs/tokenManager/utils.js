...
export const withRemainingAccountsForInvalidate = async (transaction, connection, wallet, mintId, tokenManagerData, recipientTokenAccountOwnerId, metadata) => {
    ...
    if (tokenManagerData.parsed.kind === TokenManagerKind.Programmable &&
        ...
        const releaseAccounts = remainingAccountForProgrammableUnlockAndTransfer(recipientTokenAccountOwnerId, wallet.publicKey, mintId, tokenManagerData.parsed.recipientTokenAccount, (_b = metadata === null || metadata === void 0 ? void 0 : metadata.programmableConfig) === null || _b === void 0 ? void 0 : _b.ruleSet);
        remainingAccounts.push(...releaseAccounts);
    }
    else {
        const returnAccounts = await withRemainingAccountsForReturn(transaction, connection, wallet, tokenManagerData, recipientTokenAccountOwnerId, (_d = (_c = metadata === null || metadata === void 0 ? void 0 : metadata.programmableConfig) === null || _c === void 0 ? void 0 : _c.ruleSet) !== null && _d !== void 0 ? _d : undefined);
...
export const getRemainingAccountsForClaim = (tokenManagerData, recipientTokenAccountId, metadata, claimReceiptId) => {
    ...
    if (tokenManagerData.parsed.kind === TokenManagerKind.Managed ||
        ...
        if (!((_a = metadata === null || metadata === void 0 ? void 0 : metadata.programmableConfig) === null || _a === void 0 ? void 0 : _a.ruleSet))
            throw "Ruleset not specified";
        remainingAccounts.push(...remainingAccountForProgrammable(tokenManagerData.parsed.mint, getAssociatedTokenAddressSync(tokenManagerData.parsed.mint, tokenManagerData.pubkey, true), recipientTokenAccountId, (_b = metadata === null || metadata === void 0 ? void 0 : metadata.programmableConfig) === null || _b === void 0 ? void 0 : _b.ruleSet));
    }
    if (claimReceiptId) {
        remainingAccounts.push({
