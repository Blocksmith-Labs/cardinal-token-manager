...
export const getAllTransferAuthorities = async (connection) =>
  getAllOfType(connection, "transferAuthority");
//////// MARKETPLACE ////////
...
export const getAllMarketplaces = async (connection) =>
  getAllOfType(connection, "marketplace");
//////// LISTING ////////
...
export const getAllListings = async (connection) =>
  getAllOfType(connection, "listing");
//////// Transfer ////////
