...
export const PAYMENT_MANAGER_ADDRESS = new PublicKey("DRxWY9ThgdfARwKVkUC7RYFVCxGrKdAUErHtkjDAaFAB");
...
export const paymentManagerProgram = (connection, wallet, confirmOptions) => {
    return new Program(PAYMENT_MANAGER_IDL, PAYMENT_MANAGER_ADDRESS, new AnchorProvider(connection, wallet !== null && wallet !== void 0 ? wallet : emptyWallet(PublicKey.default), confirmOptions !== null && confirmOptions !== void 0 ? confirmOptions : {}));
};
